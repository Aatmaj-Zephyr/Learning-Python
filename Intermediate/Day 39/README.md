# [Learning Python- Intermediate course: Day 39, OOP-Constructor **init**](https://dev.to/aatmaj/learning-python-intermediate-course-day-38-oop-constructor-init-2lhj)
